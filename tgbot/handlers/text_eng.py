...
share_message = "Hi!\n\n" \
                ...
                "The bot is completely free, so welcome!\n" \
                "{share_url}"

# command portfolio
wait_for_portfolio = 'In the process ⏱\n\n' # \
...
modify_balance_stock_not_in_portfolio = 'Error: this position is not included into portfolio, or this ticker does not exist.\n\n' \
                                        '<i>In the first case you should add a ticker via "➕ Add a new asset</i>"\n' \
...
delete_stock_success = 'You have removed <b><i>{symbol}</i></b> from the portfolio.'
...
add_stock_symbol_check_already_have = 'You already have <b><i>{shares}</i></b> shares / crypto coins of <b><i>({symbol})</i></b>.\n\n' \
                                      'If you want to change the balance of the stock - choose "✏️ Edit an asset"' \
                                      ' in /portfolio).'
...
add_stock_not_in_yfinance = 'Error: You entered the asset symbol incorrectly.\n\n' \
                            '<i>See the correct spelling of the symbol here https://finance.yahoo.com</i>'

language_ask = 'Choose a language:'
language_EN = "🇺🇸"
language_RU = "🇷🇺"
