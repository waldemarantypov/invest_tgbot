...
start_created_2nd_string = 'Если хочешь перейти к портфелю - жми или пиши: /portfolio\n\n' \
                           'Также нам будет приятно, если ты поможешь нам сделать бот лучше,' \
...
balance_button = '✏️ Дополнить портфель'
add_stock_button = '➕ Изменить акцию / криптомонету в портфеле'
delete_stock_button = '➖ Удалить акцию / криптомонету'
close_button = '❌ Ничего'
...
modify_balance_stock_not_in_portfolio = 'Ошибка: этой позиции нет в портфеле, либо ее в принципе не существует\n' \
                                        '<i>Если первый вариант - добавь тикер через "✏️ Дополнить портфель</i>" 🔙\n' \
